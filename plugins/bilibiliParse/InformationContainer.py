class InformationContainer:
    def __init__(self, vd_info=None, live_info=None, vd_url=None, live_url=None, image_info=None, image_url=None):
    ...
    def get_information(self):
        return self.vd_info, self.live_info, self.vd_url, self.live_url, self.image_info, self.image_url
